...
public class FieldImplementation implements Field {
    private final String[] seedArray = new String[]{
            "Phosphorus is crucial to all life on Earth, and it’s irreplaceable in food production. One of the problems that comes with the importance of phosphorus, is that the raw material reserves are unevenly distributed globally.",
            ...
            "The term “peak phosphorus” is the term used to predict the maximum production of phosphorus. It is predicted that maximum production will be around 2030, raising concerns about future phosphorus availability for agriculture. ",
            "The concept of 'peak phosphorus' highlights when global phosphorus production will reach its maximum, after which supply adjustment becomes challenging. The depletion of reserves in major countries within 40 years could significantly impact future political dynamics and potentially lead to resource conflicts.",
    };
}
