...
public class LakeImplementation implements Lake {
    ...
    public void visitlake() {
        if (Context.farmImplementation.scalePhosphor > 90) {
            ...
            PrintingUtilities.printOnScreen("There is a ROTTEN smell as you cross the bridge towards the city, you see DEAD fish floating on the lake!!!!");
        }
